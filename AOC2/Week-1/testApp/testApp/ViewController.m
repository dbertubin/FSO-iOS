...
- (void)viewDidLoad
{
    ...
    // Your classes must include the following functionality:
       ...
       // Accessor and mutator methods in the base class to get and set the values of the data members. These methods must not be overridden in the subclasses. ****** (readonly) (strong) or (weak) ???
       ...
       // Overridden versions of the previous method in the subclasses. Each class must do something slightly different, such as altering the method of calculation, to show how functionality can change in  subclasses. Found in INHERITANCE VIDEO and OVERRIDEMETHOD VIDEO menu
       ...
       // The factory should include a class (aka static) method to instantiate and return objects of the subclasses, given an argument that specifies which type.  Refer to STATIC VIDEO 
